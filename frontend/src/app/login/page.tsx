    ...
    <div className="flex h-screen bg-slate-950 items-center justify-center font-sans text-white">
      <div className="w-full max-w-md bg-slate-900 p-12 rounded-[3rem] border border-slate-800 shadow-2xl">
        <div className="text-center mb-10">
          <div className="w-14 h-14 bg-blue-600 rounded-2xl mx-auto mb-6 flex items-center justify-center font-black text-2xl shadow-lg shadow-blue-600/20">L</div>
          <h2 className="text-3xl font-black tracking-tight uppercase">SCM Terminal</h2>
          <p className="text-slate-500 text-xs mt-2 font-bold tracking-widest">SECURE OPERATOR LOGIN</p>
        </div>
